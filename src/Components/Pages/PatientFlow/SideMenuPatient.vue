      ...
      <div class="links w-full flex flex-col gap-6 z-50">
        ...
        >
          <div class="calendar flex gap-4 justify-start items-center w-full h-12 px-4">
            ...
            <p class="text-xl text-gray-300">{{ $t("home") }}</p>
          </div>
        </router-link>
        <router-link
          to="/patient/doctors"
        ...
        >
          <div class="calendar flex gap-4 justify-start items-center w-full h-12 px-4">
            ...
            <p class="text-xl text-gray-300">{{ $t("doctors") }}</p>
          </div>
        </router-link>
        ...
        >
          <div class="calendar flex gap-4 justify-start items-center w-full h-12 px-4">
            ...
            <p class="text-xl text-gray-300">{{ $t("payments") }}</p>
          </div>
        </router-link>
        <router-link
        ...
        >
          <div class="calendar flex gap-4 justify-start items-center w-full h-12 px-4">
            ...
            <p class="text-xl text-gray-300">{{ $t("adminwallettitle") }}</p>
          </div>
        </router-link>
