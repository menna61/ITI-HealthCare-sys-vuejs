  ...
  <div class="h-full cont p-8 bg-white dark:bg-gray-800 flex gap-14 rounded-xl">
    <div class="left relative">
      <div class="img relative">
        ...
        ></div>
        <img
          src="../../../public/images/signupdoctor.png"
          alt=""
      ...
      <div class="top flex flex-col gap-10">
        ...
        <div class="stepper flex flex-col gap-8">
          <div class="top flex flex-col gap-4">
            ...
            <p class="text-gray-400 dark:text-gray-300 text-xl">Create your professional account</p>
          </div>
  ...
  methods: {
    ...
    async nextStep() {
      if (this.currentStep < 3) {
        // Check email before moving from step 1 to step 2
        if (this.currentStep === 1) {
          this.loading = true;
          this.errorMsg = "";
