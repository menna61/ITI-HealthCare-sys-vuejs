<template>
  <div
    class="h-full cont p-8 bg-white dark:bg-gray-800 flex flex-col lg:flex-row gap-14 rounded-xl"
  >
    <div class="left relative">
      <div class="img relative">
        <div
          class="overlay bg-gradient-to-t from-[var(--sec-color-500)]/90 to-transparent w-full h-full absolute rounded-xl z-1"
        ></div>
        <img
          src="../../../public/images/signuppatient.png"
          alt=""
          class="w-[1600px] rounded-2xl rotate-y-180 z-0"
        />
      </div>
              ...
              <div class="flex flex-col gap-8 items-end">
                <div class="inputs w-full flex flex-col gap-4">
                  ...
                  <div class="w-full flex items-start gap-2">
                    ...
                    />
                    <label for="termsCheckbox" class="text-gray-700 dark:text-gray-300 text-sm">
                      {{ $t("I_agree_to_the") }}
                      <router-link
