    ...
    >
      <div class="left relative hidden lg:block lg:flex-shrink-0 lg:w-[600px] lg:self-stretch">
        <div class="img relative h-full min-h-full">
          ...
          ></div>
          <img
            src="../../../public/images/signuppatient.png"
            alt=""
      ...
      <div class="right flex flex-col gap-6 sm:gap-8 lg:gap-10 w-full">
        ...
        <div class="bottom flex gap-6 sm:gap-8 lg:gap-10">
          <div class="right w-full">
            <form class="flex flex-col gap-4 sm:gap-5 lg:gap-6" @submit.prevent="registerPatient">
              <google-card />

              <!-- Feedback messages -->
              <div
                v-if="errorMsg"
                class="text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-900 border border-red-100 dark:border-red-800 p-2 sm:p-3 rounded text-xs sm:text-sm"
              >
                {{ errorMsg }}
              </div>
              <div
                v-if="successMsg"
                class="text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900 border border-green-100 dark:border-green-800 p-2 sm:p-3 rounded text-xs sm:text-sm"
              >
                {{ successMsg }}
              </div>
              ...
              <fieldset
                :disabled="loading"
                class="flex flex-col gap-4 sm:gap-5 lg:gap-6 border-0 p-0"
              >
                ...
                <div class="flex flex-col gap-4 sm:gap-6 lg:gap-8 items-end">
                  <div class="inputs w-full flex flex-col gap-3 sm:gap-4">
                    <!-- Name -->
                    <div class="name flex flex-col gap-3 sm:gap-4 w-full">
                      <div class="fname w-full flex flex-col gap-2">
                        <label class="text-sm sm:text-base text-gray-900 dark:text-white">{{
                          $t("First_name")
                        }}</label>
                        <input
                          v-model="firstName"
                          ...
                          class="focus:outline-none w-full h-10 sm:h-11 lg:h-12 px-3 sm:px-4 border rounded-lg bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-sm sm:text-base text-gray-900 dark:text-white"
                        />
                      </div>
                    ...
                    <div class="flex flex-col gap-3 sm:gap-4 w-full">
                      ...
                      <div class="phone w-full flex flex-col gap-2">
                        ...
                        <input
                          ...
                          :class="[
                            'focus:outline-none w-full h-10 sm:h-11 lg:h-12 px-3 sm:px-4 border rounded-lg bg-white dark:bg-gray-700 text-sm sm:text-base text-gray-900 dark:text-white',
                            phoneNumberError
                    ...
                    <div class="w-full flex items-start gap-2">
                      ...
                      <label
                        for="termsCheckbox"
                        class="text-gray-700 dark:text-gray-300 text-xs sm:text-sm"
                      >
                        {{ $t("I_agree_to_the") }}
                        <router-link
                    ...
                    <div class="w-full flex justify-end">
                      <button
                        ...
                        :disabled="loading || !isFormValid || !acceptedTerms"
                        class="px-4 sm:px-6 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed transition-colors text-sm sm:text-base"
                      >
                        <svg
                          v-if="loading"
